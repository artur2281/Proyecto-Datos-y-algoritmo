...
entry_usuario = CTkEntry(frame, font=('TkDefaultFont', 12), placeholder_text='Usuario',
...
entry_contrasena = CTkEntry(frame, font=('TkDefaultFont', 12), placeholder_text='Contraseña',
    border_color=c_verde, fg_color=c_negro, width=220, height=40, show='*')
entry_contrasena.grid(columnspan=2, row=2, padx=4, pady=4)

bt_iniciar = CTkButton(frame, font=('TkDefaultFont', 12), border_color=c_verde, fg_color=c_negro,
...
resultado_label = CTkLabel(frame, font=('TkDefaultFont', 12), fg_color=c_negro, text="")
