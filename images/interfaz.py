...
usuario = CTkEntry(frame, font=('sans serif', 12), placeholder_text='Usuario',
...
# Agregar función para el botón de inicio de sesión
def iniciar_sesion():
    if usuario.get() == "TEVIS" and password.get() == "12345":
        root.deiconify()
...
bt_iniciar = CTkButton(frame, font=('sans serif', 12), border_color=c_verde, fg_color=c_negro,
    ...
    text='INICIAR SESION', height=40, command=iniciar_sesion)
